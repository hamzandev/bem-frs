<span class="bg-green-400 text-xs font-medium me-2 px-2.5 py-0.5 rounded flex w-max text-white">
    ...
    <a href="/artikel/categories/{{ $category ?? "#" }}" class="text-white no-underline">
